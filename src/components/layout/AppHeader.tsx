...
const AppHeaderLogo: React.FC = () => (
  <svg
    width="32" // Increased size (was 28, then 24)
    height="32" // Increased size (was 28, then 24)
    viewBox="0 0 24 24"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="text-foreground opacity-80 group-hover:opacity-100 transition-opacity"
    style={{ filter: 'drop-shadow(0 3px 6px rgba(0,0,0,0.3))' }} // Adjusted shadow for new size
  >
